...
std::string MainWindowApp::connectionCurl(std::string url)
{
	std::string result;
	CURL* curl;
	CURLcode res;
...
void MainWindowApp::jsonCovidUI(QJsonDocument json_doc)
{
...
void MainWindowApp::jsonVaccinesUI(QJsonDocument json_doc2)
{
...
{
	std::string urlJson = "https://www.graphs.ro/json.php";
	std::string result = connectionCurl(urlJson);
	...
	jsonCovidUI(json_doc);

	std::string urlVaccinare = "https://www.graphs.ro/vaccinare_json.php";
	std::string resultVaccinare = connectionCurl(urlVaccinare);
